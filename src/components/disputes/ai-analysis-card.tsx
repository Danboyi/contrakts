...
export function AiAnalysisCard({
  ...
  return (
    <div
      className={cn(
        'w-full overflow-hidden rounded-[var(--radius-xl)] border',
        'border-[hsl(var(--color-accent)/0.15)] bg-[hsl(var(--color-accent)/0.04)]'
      )}
    >
      <div
        className={cn(
            ...
            {!canRequest ? (
              ...
              <>
                ...
                <button
                  ...
                  disabled={isPending}
                  className={cn(
                    'mt-4 flex min-h-[44px] items-center gap-2 rounded-[var(--radius-md)] px-5 py-2.5',
              ...
              <div className="flex-1">
                <p className={cn('text-sm font-semibold', rulingConfig.color)}>
                  ...
                  {analysis.recommended_ruling === 'partial'
                    ? ` - ${analysis.vendor_pct}% to service provider`
                    : ''}
                </p>
                <p className="mt-0.5 text-xs text-[hsl(var(--color-text-3))]">
