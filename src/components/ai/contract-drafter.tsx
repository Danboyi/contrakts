        ...
        {phase === 'input' && (
          ...
          >
            ...
            <button
              ...
              className="text-left text-xs text-[hsl(var(--color-text-3))] transition-colors hover:text-[hsl(var(--color-accent))]"
            >
              Try an example
            </button>
            ...
            <button
              ...
              className={cn(
                'inline-flex h-14 items-center justify-center gap-3 rounded-[var(--radius-xl)] text-base font-semibold transition-all duration-200',
                'active:scale-[0.98]',
          ...
          >
            ...
            <section className="rounded-[var(--radius-xl)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))]">
              <div className="flex items-start justify-between gap-4 border-b border-[hsl(var(--color-border))] px-5 py-4">
                ...
                <button
                  ...
                  className="rounded-[var(--radius-sm)] border border-[hsl(var(--color-border))] px-2.5 py-1 text-xs font-medium text-[hsl(var(--color-text-2))] transition hover:border-[hsl(var(--color-accent)/0.35)] hover:text-[hsl(var(--color-accent))]"
                >
                  Edit
                </button>
              </div>
            ...
            <section className="rounded-[var(--radius-xl)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))]">
              ...
              <div className="space-y-3 px-5 py-4">
                {draft.milestones.map((milestone, index) => (
                  <div
                    key={`${milestone.title}-${index}`}
                    className="flex items-start gap-3 rounded-[var(--radius-md)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface-2))] p-3"
                  >
            ...
            <section className="rounded-[var(--radius-xl)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))]">
              ...
              <div className="space-y-3 px-5 py-4">
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-[var(--radius-md)] bg-[hsl(var(--color-surface-2))] px-3 py-2 text-left text-sm font-medium text-[hsl(var(--color-text-2))]"
                >
              ...
              <div className="rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-4">
                ...
                <div className="mt-3 flex gap-2">
                  <button
                    ...
                    className="inline-flex h-10 items-center gap-2 rounded-[var(--radius-md)] bg-[hsl(var(--color-accent))] px-4 text-sm font-semibold text-white transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    {isPending ? (
                  ...
                  <button
                    ...
                    className="inline-flex h-10 items-center rounded-[var(--radius-md)] px-4 text-sm text-[hsl(var(--color-text-3))] transition hover:text-[hsl(var(--color-text-1))]"
                  >
                    Cancel
                  </button>
                </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <button
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-[var(--radius-lg)] border border-[hsl(var(--color-border-2))] px-4 text-sm text-[hsl(var(--color-text-2))] transition hover:border-[hsl(var(--color-accent)/0.35)] hover:text-[hsl(var(--color-accent))]"
              >
                <Edit3 size={14} />
                Refine
              </button>
              <button
                type="button"
                onClick={() => void generate()}
                className="inline-flex h-12 items-center justify-center gap-2 rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] px-4 text-sm text-[hsl(var(--color-text-3))] transition hover:text-[hsl(var(--color-text-1))]"
              >
                <RefreshCw size={14} />
                Regenerate
              </button>
