...
export function PartyCard({
  ...
  if (!user) {
    return (
      <div className="w-full flex-1 rounded-[var(--radius-lg)] border border-dashed border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-4">
  ...
  return (
    <div
      className={cn(
        'w-full flex-1 rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-4',
        isYou &&
