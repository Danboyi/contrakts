      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={cn(
            ...
            'w-[calc(100vw-1rem)] max-w-[calc(100vw-1rem)] sm:w-full sm:max-w-[calc(100vw-2rem)]',
...
export function ModalFooter({
  ...
  return (
    <div
      className={cn(
        'mt-6 flex flex-col-reverse items-stretch justify-end gap-3 border-t border-[hsl(var(--color-border))] pt-5 sm:flex-row sm:items-center',
        className
      )}
      {...props}
    />
