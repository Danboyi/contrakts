  ...
  return (
    <Card padded>
      <div className="mb-3 flex items-start justify-between gap-3">
        <p className="min-w-0 flex-1 text-xs font-medium uppercase tracking-wide text-[hsl(var(--color-text-3))]">
          {label}
        </p>
        {icon && (
          <div className="flex-shrink-0 rounded-[var(--radius-sm)] bg-[hsl(var(--color-surface-2))] p-1.5">
            {icon}
          </div>
        )}
      </div>
      <p className="mb-1 text-xl font-semibold leading-none text-[hsl(var(--color-text-1))] sm:text-2xl">
        {value}
      </p>
      {sub && (
        <p
