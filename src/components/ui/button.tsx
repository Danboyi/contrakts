...
const buttonVariants = cva(
  ...
  ].join(' '),
  {
    variants: {
      ...
      size: {
        sm: 'h-11 px-3.5 text-xs rounded-[var(--radius-sm)] md:h-8 md:px-3',
        md: 'h-[44px] px-4 text-sm rounded-[var(--radius-md)]',
        lg: 'h-12 px-6 text-base rounded-[var(--radius-md)]',
        icon: 'h-11 w-11 rounded-[var(--radius-md)] md:h-9 md:w-9',
        'icon-sm': 'h-11 w-11 rounded-[var(--radius-sm)] md:h-7 md:w-7',
      },
    },
    defaultVariants: {
      variant: 'primary',
