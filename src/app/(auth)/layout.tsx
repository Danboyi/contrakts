...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen overflow-x-hidden bg-[hsl(var(--color-bg))]">
      <div
        className="hidden lg:flex lg:min-h-screen lg:w-1/2 lg:flex-shrink-0 lg:flex-col lg:justify-between lg:px-10 lg:py-12 xl:px-12"
        style={{
      ...
      <div
        className="flex min-h-screen w-full items-center justify-center px-4 py-8 sm:px-6 sm:py-10 lg:w-1/2 lg:px-8 lg:py-12"
        style={{
          minHeight: '100vh',
        }}
      >
        ...
        >
          <div className="mb-8 text-center lg:hidden">
            <div className="mb-2 flex items-center justify-center gap-2">
              <span className="h-2 w-2 rounded-full bg-[hsl(var(--color-accent))]" />
              <span className="text-lg font-semibold text-[hsl(var(--color-text-1))]">
                Contrakts
              </span>
            </div>
