...
export function SignupClient() {
  ...
  if (success) {
    return (
      <div className="w-full">
        <div
          className="rounded-[var(--radius-xl)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-6 text-center sm:p-8"
        >
          <div
            style={{
              width: '56px',
  ...
  return (
    <div className="w-full">
      <div className="rounded-[var(--radius-xl)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-6 sm:p-8">
      <h2
        style={{
          fontSize: '24px',
          fontWeight: 600,
