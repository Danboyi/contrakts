...
function MilestoneCard({
  ...
  return (
    <div className="overflow-hidden rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface-2))] transition-all duration-200">
        ...
        <div className="grid flex-1 grid-cols-1 gap-3 md:grid-cols-5">
          <div className="md:col-span-3">
            <input
              ...
              className={cn(
                'h-[40px] w-full rounded-[var(--radius-md)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] px-3',
          ...
          <div className="md:col-span-2">
            <div className="relative">
              ...
              <input
                ...
                step="0.01"
                className={cn(
                  'h-[40px] w-full rounded-[var(--radius-md)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] pl-7 pr-3',
                  'text-sm text-[hsl(var(--color-text-1))] placeholder:text-[hsl(var(--color-text-3))] outline-none transition-all duration-150',
                  'focus:border-[hsl(var(--color-accent))] focus:shadow-[0_0_0_3px_hsl(var(--color-accent)/0.12)]'
                )}
              />
      ...
      {expanded && (
        <div className="grid grid-cols-1 gap-3 border-t border-[hsl(var(--color-border))] px-4 pb-4 pt-3 md:grid-cols-2">
          <div className="md:col-span-2">
            <textarea
        ...
        <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
          {TERMS_TEMPLATES.map((template) => (
            <button
              ...
              className={cn(
                'rounded-[var(--radius-md)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface-2))] px-3 py-2.5 text-left text-xs',
  ...
  return (
    <div className="flex flex-col gap-5">
      {[
        ...
        <div
          key={label}
          className="flex items-start justify-between border-b border-[hsl(var(--color-border))] py-3 last:border-0"
        >
          <span className="text-xs uppercase tracking-wide text-[hsl(var(--color-text-3))]">
            {label}
          </span>
          <span className="max-w-[60%] text-right text-sm font-medium text-[hsl(var(--color-text-1))]">
            {value}
          </span>
        </div>
      ))}
      ...
      <div className="rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface-2))] p-4">
        <p className="text-xs leading-relaxed text-[hsl(var(--color-text-3))]">
          ...
          payment before it reaches the vendor.
        </p>
      </div>
    </div>
  )
