    ...
    >
      <div>
        {back && (
          <Link
            href={back.href}
            className="group mb-3 inline-flex items-center gap-1.5 text-xs text-[hsl(var(--color-text-3))] transition-colors duration-200 hover:text-[hsl(var(--color-accent))]"
          >
            <svg
              width="12"
              height="12"
        ...
        {subtitle && (
          <p className="mt-1.5 text-sm text-[hsl(var(--color-text-2))]">
            {subtitle}
          </p>
        )}
      </div>
